...
SWEP.ViewModel = "models/reshed_arc9_ump45.mdl"
...
SWEP.ShootSound = "weapons/ump45/fire.wav"                            -- Fire
...
SWEP.Animations = {
    ...
    ["inspect"] = {
        Source = "inspect",
	      IKTimeLine = {
			...
			{s = "weapons/ump45/magout.wav", t = 2},
			{s = "weapons/shared/reloadend.wav", t = 3.1},
			{s = "weapons/shared/reloadstart.wav", t = 4.2},
			{s = "weapons/ump45/maghit.wav", t = 4.7},
			{s = "weapons/ump45/magin.wav", t = 4.8},
			{s = "weapons/shared/reloadstart.wav", t = 5.2},
			{s = "weapons/shared/deploy.wav", t = 6.5},
			},
        },
    ["reload"] = {
        Source = "reload",
        ...
        EventTable = {
		    ...
		    {s = "weapons/ump45/magrelease.wav", t = 0.17},
			{s = "weapons/ump45/magout.wav", t = 0.25},
			{s = "weapons/shared/deploy.wav", t = 1.1},
			{s = "weapons/ump45/maghit.wav", t = 1.55},
			{s = "weapons/ump45/magin.wav", t = 1.65},
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
		    {s = "weapons/shared/reloadstart.wav", t = 0},
		    {s = "weapons/ump45/magrelease.wav", t = 0.17},
			{s = "weapons/ump45/magout_empty.wav", t = 0.25},
			{s = "weapons/shared/deploy.wav", t = 1.1},
			{s = "weapons/ump45/maghit.wav", t = 1.55},
			{s = "weapons/ump45/magin.wav", t = 1.65},
			{s = "weapons/ump45/boltcatch.wav", t = 2.1},
